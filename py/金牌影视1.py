...
class Spider(Spider):
    ...
    def init(self, extend=""):
        hosts = "https://www.jiabaide.cn"  # 默认站点，可写多个: "https://www.jiabaide.cn,域名2,域名3"
        if extend:
            try:
    ...
    def detailContent(self, ids):
        ...
        vod['vod_play_url'] = '#'.join(
            f"{i['name'] if len(vod['episodelist']) > 1 else vod['vod_name']}${ids[0]}@@{i['nid']}" for i in vod['episodelist'])
