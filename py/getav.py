...
class Spider(SpiderBase):
    ...
    def homeVideoContent(self):
        ...
        for m in movies:
            ...
            v_list.append({
                ...
                "vod_remarks": "🐑就愛薅羊毛 | %s" % dur if dur else "🐑就愛薅羊毛",
        ...
        if str(tid).startswith("folder@@"):
            ...
            if f_type == "stars":
                ...
                for s in stars:
                    ...
                    remarks = f"🐑就愛薅羊毛 | {count}部" if count else "🐑就愛薅羊毛"
            ...
            # B. 类型大全
                ...
                for g in items:
                    ...
                    remarks = "🐑就愛薅羊毛 | %s部" % count if count else "🐑就愛薅羊毛"
                    v_list.append({
    ...
    def detailContent(self, ids):
        ...
        remarks = "🐑就愛薅羊毛 | %s" % dur_str if dur_str else "🐑就愛薅羊毛"
